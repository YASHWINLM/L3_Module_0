...
public class SearchingAndSortingAlgorithms {
	...
	public void testSearch() {
		...
		List<String> eggs2 = Arrays.asList(new String[] { "whole", "whole", "whole", "whole", "whole", "whole", "whole", "whole",
				"cracked", "whole", "whole", "whole" });
		assertEquals(8, Algorithms.findBrokenEgg(eggs2));
		List<String> eggs3 = Arrays.asList(new String[] { "whole", "whole", "whole", "whole", "whole", "whole", "whole", "whole",
				"whole", "whole", "whole", "whole" });
		assertEquals(-1,Algorithms.findBrokenEgg(eggs3));
	}
	...
	List<Boolean> oysters = Arrays.asList(new Boolean[] { false, false, true, false, false, false, false, false, false, false, false,
		...
		List<Boolean> oysters2 = Arrays.asList(new Boolean[] { false, false, false, false, false, false, false, false, false, false, false,
				false, false, false, false, false, false, false, false, false, false, false, false, false });
		assertEquals(0, Algorithms.countPearls(oysters2));
		List<Boolean> oysters3 = Arrays.asList(new Boolean[] { true, true, true, true, true, true, true, true, true, true, true,
				false, false, false, false, false, false, false, false, false, false, false, false, false });
		assertEquals(11, Algorithms.countPearls(oysters3));
	...
	public void testFindMaxiumum() throws Exception {
		...
		List<Double> peeps2 = Arrays.asList(new Double[] { 5.1, 4.2, 3.4, 5.2, 5.5, 5.5, 4.7, 7.2, 3.4, 9.2, 1.0, 4.5, 5.1, 6.6 });
		assertEquals(9.2, Algorithms.findTallest(peeps2), 0.0);
		List<Double> peeps3 = Arrays.asList(new Double[] { 0.1,0.2,0.1,0.3,0.5,0.6,0.8,10.3,0.5,0.4,0.1,0.5 });
		assertEquals(10.3, Algorithms.findTallest(peeps3), 0.0);
	}
	...
	public void testFindMaxiumumString() throws Exception {
		List<String> words = Arrays.asList(new String[] { "accoutrements", "acumen", "anomalistic", "auspicious", "bellwether",
				...
				"osculator", "parsimonious", "penultimate", "perfidiousnes", "perspicacious", "proficuous", "remunerative", "saxicolous",
				"sesquipedalia", "superabundant", "unencumbered", "unparagoned", "usufruct", });
		assertEquals("circumlocution", Algorithms.findLongestWord(words));
		List<String> words2 = Arrays.asList(new String[] { "cat","house", "pasta","hi", "good","usufruct" });
		assertEquals("usufruct", Algorithms.findLongestWord(words2));
		List<String> words3 = Arrays.asList(new String[] {   "circumlocution", "proficuous", "remunerative", "saxicolous",
				"sesquipedalian", "usufruct", });
		assertEquals("circumlocution", Algorithms.findLongestWord(words3));
	}
